...
!function(w, $){
	...
	Factory.prototype = {
		options: {
			...
			skinPath: "js/xyPop/skin/"			//css或image路径
		},
		init: function(){
			...
			c.html(
				...
				+ '<div class="xy-ui-wrapper anim-ui-wrapper">'
					...
					+	(opt.type ? '<div style="text-align:left;"><span style="background:url('+ opt.skinPath + opt.type +'_icon.gif) no-repeat 0 center;display:inline-block;padding:0.75rem 0 0.75rem 2.625rem;">' + opt.content + '</span></div>' : opt.content)
					+ '</div>'
					/*底部区域*/
